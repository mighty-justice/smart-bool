...
var SmartBool = /*#__PURE__*/function () {
  function SmartBool(initial) {
    if (initial === void 0) {
      initial = false;
    }
  ...
  var _proto = SmartBool.prototype;
  ...
  _proto.setTrue = function setTrue() {
    return this.set(true);
  };

  _proto.setFalse = function setFalse() {
  ...
  /*#__PURE__*/
  function () {
    var _until = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(request) {
  ...
  _proto._stringIfTrueElse = function _stringIfTrueElse(ifTrue, ifFalse) {
  ...
  _proto.saving = function saving(label) {
    if (label === void 0) {
      label = 'Save';
    }
